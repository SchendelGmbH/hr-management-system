...
const io = new Server(httpServer, {
  cors: {
    origin: ['http://localhost:3000', 'http://srv1471808.tail4c3c89.ts.net:3000', 'https://srv1471808.tail4c3c89.ts.net:3000'],
    methods: ['GET', 'POST'],
    credentials: true,
  },
});
...
httpServer.listen(port, () => {
  ...
  console.log(`[Socket.IO] CORS enabled for: http://localhost:3000, http://srv1471808.tail4c3c89.ts.net:3000`);
});
