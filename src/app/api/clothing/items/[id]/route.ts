...
export async function GET(
  ...
  const authResult = await requirePermission(request, 'clothing', 'view_items');
...
export async function PUT(
  ...
  const authResult = await requirePermission(request, 'clothing', 'edit_item');
  if (authResult.error) return authResult.error;
...
export async function DELETE(
  ...
  const authResult = await requirePermission(request, 'clothing', 'delete_item');
  if (authResult.error) return authResult.error;
  const { session } = authResult;
